...
public class knownDiningServiceScenarioTest extends AbstractWebTest{
  ...
  @Test
  @Order(3)
  @DisplayName("Third, Serch for a known location")
  void searchForKnown() {
    Page.search("Beanz");
    Page.clickFirstResult();
    assertEquals(Page.getHours(),"8:00AM - 2:00PM");
  }
}
